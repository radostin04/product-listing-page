...
const LayoutGrid = () => {
  ...
  const [activeSortingMode, setActiveSotringMode] = useState<
    "A-Z" | "Z-A" | "Price (asc.)" | "Price (dec.)"
  >("A-Z");
  ...
  //Track if the filters should be shown even when they normally wouldn't be (on mobile)
  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.productsHeader}>
        <CategoryHeader
          categoryName={productsCtx.activeCategory!.name}
          description={productsCtx.activeCategory!.description}
        />
        <button
          className={classes.filtersButton}
          onClick={() => {
            setForceShowFilters(true);
          }}
        >
          Filters
        </button>
        <Dropdown buttonText={`Sort: ${activeSortingMode}`}>
          ...
          <DropdownElement
            ...
            label="Price (asc.)"
            onClick={() => {
              setActiveSotringMode("Price (asc.)");
            }}
          ></DropdownElement>
          <DropdownElement
            className={classes.dropdownElement}
            label="Price (dec.) "
            onClick={() => {
              setActiveSotringMode("Price (dec.)");
            }}
          ></DropdownElement>
        </Dropdown>
      </div>
